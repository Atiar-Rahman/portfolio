...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      desc: "This website create django. This application use Events Manage and Event participant maintain and participant easily can to add specific event. role wise dashboard access",
      tech: ["django MVT pattern", "MySql"],
      img: "/project1.png ",
